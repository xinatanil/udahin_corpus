...
BLOCKQUOTE_TO_TRN = [
    ...
    '<blockquote>детский свивальник (две повязки для связывания в колыбели рук и ног ребёнка: кол боортко, аяк боортко);</blockquote>',
    '<blockquote>ведь, же (после глухих согласных произносится ко, что часто встречается и в написании или кү в некоторых южных говорах);</blockquote>',
    '<blockquote>посещать невесту на правах жениха и ночевать у неё (на это испрашивалось предварительное согласие родителей невесты; ср. күйөөлөш-);</blockquote>',
    '<blockquote>помощь, споспешествование (гл. обр. в религиозном смысле).</blockquote>',
    '<blockquote>что (в сочет. с бир и ар в фольклоре встречаются и разговорные формы: неңке, деме, деңке);</blockquote>',
    '<blockquote>так обычно, оплакивая, называет вдова своего умершего в молодости мужа или женщина умершего молодого мужчину (в этом смысле чаще күл ойрон);</blockquote>',
    '<blockquote>наводнение, бурные потоки дождевых вод или вод от таяния снега; сель, селевой поток;</blockquote>',
    '<blockquote>ты (сенин род. п., сени вин. п., сага или саа или саган или неправ. са или южн. саңа дат. п., сенде местн. п., сенден исх. п.);</blockquote>',
    '<blockquote>деепр. наст. вр. от утраченного в киргизском языке глагола сы- ломать; сый чап- или сыя чап- (мечом), сый ат- или сыя ат- (стрелой, пулей), сый кой- (независимо от вида оружия) переломить, повредить;</blockquote>',
    '<blockquote>вид беркута (который, в свою очередь, делится на подвиды: сөөк сыргак и аяк сыргак);</blockquote>',
    '<blockquote>место сгиба ноги у колена;</blockquote>',
    '<blockquote>чарпая (большая деревянная кровать на несколько человек; обычно ставится на открытом воздухе или в чайхане);</blockquote>',
    '<blockquote>оспа (у людей; иносказательно эту болезнь называют: улуу тумоо или чоң жарыктык или баягы жарыктык или баягы);</blockquote>',
    '<blockquote>чижик (детская игра, при которой употребляются две палочки: бала или бала чикит палочка, длиною около 1/4 аршина, и эне или эне чикит палочка, длиною около аршина; на юге эти палочки соответственно называются ат и таяк);</blockquote>',
    '<blockquote>пустыня; степь, равнина (всё, что не тоо и не көл);</blockquote>',
    '<blockquote>слово это входит в состав названий пород беркутов: иленин чөлү, бөксөнүн чөлү и др.;</blockquote>',
    '<blockquote>кречет (киргизские охотники различают шесть видов: байпактуу шумкар, күйкө шумкар (считается наиболее ценным), катуу бүркөр, кара шумкар, ак шумкар, ителги; в старом быту, когда дарили девятку ловчих птиц, то возглавлял эту девятку күйкө шумкар);</blockquote>',
...
\t\t\t<trn>сила ветра;</trn>''',
    ...
    (
        '''<blockquote>чалканчылар келип чаң салса, зыяны барбы?разве вредно, если явятся сотрудники "Чалкан"'а и взбудоражат?</blockquote>''',
        '''<blockquote>чалканчылар келип чаң салса, зыяны барбы? разве вредно, если явятся сотрудники "Чалкан"'а и взбудоражат?</blockquote>''',
    ),
    (
...
\t\t</meaning>''',
    ...
    (
        '''<blockquote>чайга күтүүгө убакыт жок,</blockquote>
...
\t\t\t\t<xr>то же, что <wordLink word="төрт эли"/> (см. <wordLink word="эли"/>);</xr>''',
    ...
    (
        '''<trn>заветная мечта;</trn>
\t\t\t<blockquote>неисполненное или неудовлетворённоё желание; сожаление о неисполненном или неудовлетворённом желании;</blockquote>''',
        '''<trn>заветная мечта; неисполненное или неудовлетворённоё желание; сожаление о неисполненном или неудовлетворённом желании;</trn>''',
    ),
    (
        '''<meta>(в эпосе)</meta>
\t\t\t<trn>пистонное ружьё</trn>
\t\t\t<blockquote>(в отличие от кремнёвого и фитильного; встречается с различными определениями: ак бараң, көк бараң, кара бараң, сыр бараң - такие определения, видимо, объясняются внешней отделкой ружья);</blockquote>''',
        '''<meta>(в эпосе)</meta>
\t\t\t<trn>пистонное ружьё (в отличие от кремнёвого и фитильного; встречается с различными определениями: ак бараң, көк бараң, кара бараң, сыр бараң - такие определения, видимо, объясняются внешней отделкой ружья);</trn>''',
    ),
    (
        '''<origin>ир.</origin>
\t\t<meta>южн. [бийәвән]</meta>
\t\t<blockquote>(в эпосе) пустыня (часто в сочетании с чөл);</blockquote>''',
        '''<origin>ир.</origin>
\t\t<meta>южн. [бийәвән]</meta>
\t\t<meta>(в эпосе)</meta>
\t\t<trn>пустыня (часто в сочетании с чөл);</trn>''',
    ),
    (
        '''<trn>дождевик, чёртова тавлинка (род гриба, наполненного пылью;</trn>
\t\t\t<blockquote>в народной медицине употребляется в качестее присыпки на раны);</blockquote>''',
        '''<trn>дождевик, чёртова тавлинка (род гриба, наполненного пылью; в народной медицине употребляется в качестее присыпки на раны);</trn>''',
    ),
    (
        '''<trn>трясти;</trn>
\t\t\t<blockquote>приводить что-л. в движение;</blockquote>''',
        '''<trn>трясти; приводить что-л. в движение;</trn>''',
    ),
    (
        '''<blockquote>жамгыр чаба жаайт дождь бьёт в лицо;</blockquote>
\t\t<blockquote>дождь бьёт против приподнятого түндүк'а (см.) я попадает в юрту.</blockquote>''',
        '''<blockquote>жамгыр чаба жаайт дождь бьёт в лицо; дождь бьёт против приподнятого түндүк'а (см.) я попадает в юрту.</blockquote>''',
    ),
    (
        '''<blockquote>эсери болбой, эл болбойт;</blockquote>
\t\t\t<blockquote>эпкини болбой, сел болбойт фольк. не бывает народа без придурковатого (у каждого народа такие есть), не бывает силевого потока (см. <wordLink word="сел" meaning="1"/>) без сильного ветра (который нагоняет тучи);</blockquote>''',
        '''<blockquote>эсери болбой, эл болбойт; эпкини болбой, сел болбойт фольк. не бывает народа без придурковатого (у каждого народа такие есть), не бывает силевого потока (см. <wordLink word="сел" meaning="1"/>) без сильного ветра (который нагоняет тучи);</blockquote>''',
    ),
    (
...
\t\t<blockquote>бейшеби бекиди (у него) задержание мочи.</blockquote>''',
    ...
    (
        '''<trn>рождённый от бека (см. <wordLink word="бек" homonym="II"/>);</trn>
\t\t<blockquote>"высокородный", "благородного" происхождения.</blockquote>''',
        '''<trn>рождённый от бека (см. <wordLink word="бек" homonym="II"/>); "высокородный", "благородного" происхождения.</trn>''',
    ),
    (
...
\t\t\t<blockquote>а сколько в нём содержания? (напр. у овцы спина трясётся, будто от жира, но это может быть только видимость).</blockquote>''',
        '''<blockquote>сүлкүлдөйт да, сүлкүлдөйт! салмагы канча болду экен мунун? внешне - да! ну, а сколько в нём содержания? (напр. у овцы спина трясётся, будто от жира, но это может быть только видимость).</blockquote>''',
    ),
    (
        '''<meta>южн.</meta>
\t\t\t\t<blockquote>(в скачках с козлёнком; см. <wordLink word="улак" meaning="2"/>)</blockquote>
\t\t\t\t<blockquote>бросить козлёнка на землю у финиша (не передав его другому спортсмену, что считается победой);</blockquote>''',
        '''<meta>южн.</meta>
\t\t\t\t<meta>(в скачках с козлёнком; см. <wordLink word="улак" meaning="2"/>)</meta>
\t\t\t\t<trn>бросить козлёнка на землю у финиша (не передав его другому спортсмену, что считается победой);</trn>''',
    ),
    (
        '''<blockquote>именное образование от өт- II (указывает на действие, совершаемое мимоходом; употребляется только в вспомогательной роли);</blockquote>''',
        '''<trn>именное образование от өт- II (указывает на действие, совершаемое мимоходом; употребляется только в вспомогательной роли);</trn>''',
    ),
    (
        '''<trn>сладкий;</trn>
\t\t\t<blockquote>перен. обычно в сочетании с ачуу:</blockquote>''',
        '''<trn>сладкий; перен. обычно в сочетании с ачуу:</trn>''',
    ),
    (
