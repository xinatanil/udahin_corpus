...
manual_exceptions = [
    ...
    'слово, употребляющееся обычно в паре с эпте- или в сопровождении эпте- (см.).',
    '(гл. обр. о стройной, красивой девушке, молодухе)',
    '(в народной медицине)',
	'с предшеств. дат. п. и с послелогом менен (калька с русского)',
	'(встречается только в рифме с көздө-)',
	'с предшеств. числительным',
	'(о открытое)',
	'(о рассвете)',
	'чаще с отриц.',
    '(наст.-буд. вр, 3 л. тууйт и тубат, буд. вр. туур и тубар)',
    '(о полном человеке; ср. чедирей-)',
    '(с казахского)',
	'(обычно с притяж. аффиксом 1 л.)',
    'деепр. наст. вр. от чап- X',
    'только в сочет. с ич I (см.).',
    'обычно в сочет. с баш;',
    '(обычно в паре с ырыс)',
    '(обычно в паре с кир)',
    '(обычно в сочет. с кол)',
    'прил. к күн;',
    'действие по гл. кус-;',
    '(от сл. манифест)',
    '(обычно в сочет. с сөлөкөт)',
    '(обычно с көз)',
    '(сокр. от эгесиз)',
    '(от эже I)',
    'прич. прош. вр. от э- II',
    '(в сочет. с жүрөк)',
	'(обычно в сочет. с оору-)',
    ...
    '(у синьцз. киргизов)',
	'в отриц. обороте',
	'(обычно долгое) межд. побудительное',
	'(у синьцзянских киргизов и в эпосе)',
    '(фонетический вариант банд)',
    '(о дереве)',
    '(о духовенстве)',
    '(от начала до конца с губной окраской)',
    '(вместо кадар)',
    '(о молодой женщине, невесте)',
    '(обычно с притяж. аффиксом 3 л.)',
    '(иногда встречается и в эпосе)',
    '(на севере и в лит. редко)',
    '(и в местах близкого соседства с казахами)',
    'с притяж. аффиксом 3 л.',
...
with open(inputFilename, 'r' ) as f:
    ...
    content_new = re.sub(
        r'(<k>дубляж</k>\s*)<blockquote>кино</blockquote>',
        r'\1<meta>кино</meta>',
        content_new,
        flags=re.M
    )
    content_new = re.sub(
        r'(<k>дублёр</k>\s*)<blockquote>кино, театр\.</blockquote>',
        r'\1<meta>кино</meta>\n\t\t<meta>театр.</meta>',
        content_new,
        flags=re.M
    )
    content_new = re.sub(
        r'(<k>кадр</k>\s*)<blockquote>кино, фото</blockquote>',
        r'\1<meta>кино</meta>\n\t\t<meta>фото</meta>',
        content_new,
        flags=re.M
    )
    content_new = re.sub(
        r'<blockquote>ир. южн. предлог</blockquote>',
        r'<meta>ир.</meta>\n\t\t<meta>южн.</meta>\n\t\t<meta>предлог</meta>',
        content_new,
        flags=re.M
    )
